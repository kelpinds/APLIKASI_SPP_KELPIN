...
private void buattabel() {
        ...
        try {
            while (rs.next()) {
               ...
               baris.add(rs.getString("kopetensi_keahlian"));
               kp.addRow(baris);
            }
    ...
    private void initComponents() {
        ...
        kope = new javax.swing.JTextField();
        ...
        tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID kelas", "Nama Kelas", "Kopetensi Keahlian"
            }
        ));
        ...
        jLabel2.setText("Kopetensi Keahlian");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(kope, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanMouseClicked
        ...
        String kp = kope.getText();
      
        
        String sql = "insert into kelas(nama_kelas,kopetensi_keahlian) values('"+nm+"','"+kp+"')";
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        String nm = nama.getText();
        String kp = kope.getText();
        String sql = "update kelas set nama_kelas='"+nm+"' ,kopetensi_keahlian='"+kp+"' where id_kelas="+kode;
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        kope.setText(tabel.getValueAt(nobaris, 2).toString());
    ...
    private javax.swing.JTextField kope;
